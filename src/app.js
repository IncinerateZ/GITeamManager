...
const faqanswers = {
    ...
    1 : "Numerical data are manually compiled from the official wiki, otherwise data regarding upcoming characters or weapons are taken from <a href='https://g-hhw.com' style='color:#555'>Honey Hunter World</a>.",

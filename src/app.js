...
const polearmlist = ["beginners-protector", "black-tassel", "blackcliff-pole", "crescent-pike", "deathmatch", "dragons-bane", "dragonspine-spear","favonius-lance", "halberd", "iron-point", /*"kunwus-iris-rift"*/, "lithic-spear", "primordial-jade-winged-spear", "prototype-grudge", "skyward-spine", "staff-of-homa", "vortex-vanquisher","white-tassel"];
const swordlist = ["aquila-favonia", "blackcliff-longsword", "cool-steel", "dark-iron-sword", "dull-blade", "favonius-sword", "festering-desire", "fillet-blade", "harbinger-of-dawn", "iron-sting", "lions-roar", "primordial-jade-cutter", "prototype-rancour", "royal-longsword", "sacrificial-sword", "silver-sword", "skyrider-sword", "skyward-blade", "summit-shaper",/*"the-alley-flash",*/ "the-black-sword", "the-flute", "travelers-handy-sword"];
